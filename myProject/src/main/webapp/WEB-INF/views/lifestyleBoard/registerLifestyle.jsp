        ...
        <div class="row">
        	...
        	<div class="box">
        		<div class="col-lg-12">
        			...
        			&nbsp;
        			<strong> LIFESTYLE REGISTER</strong>
        		</div>
        	</div>        	
            ...
            <div class="box">
	            ...
	            <form action="registerLifestyle" method="post" id="registerForm" enctype="multipart/form-data">
		            ...
		            <div class="col-md-12">
						<div class="input-group">
	  						...
	  						<input type="text" class="form-control" placeholder="제목" aria-describedby="basic-addon1" name="lTitle">
						</div>
					...
					<div class="col-md-12">	
						...
						<textarea class="form-control" rows="40" placeholder="내용" name="lContent" id="lContent"></textarea>
