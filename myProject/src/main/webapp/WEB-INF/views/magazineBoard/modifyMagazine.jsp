...
<body>
    ...
    <div class="container">
        ...
        <form action="modifyMagazine" method="post" id="formObj" enctype="multipart/form-data">

				<input type="hidden" name="mNo" value="${readMagazine.mNo}"/>
        	...
        	<div class="box">
        		<div class="col-lg-12">
        			<input type="text" class="form-control" value="${readMagazine.mTitle }" name="mTitle"/>
        		...
        		<div class="col-lg-12">
        			<div>
        				...
        				<div style="float: right;">
        					...
        					<span>댓글 ${readMagazine.replyCnt }</span>
        				</div>
	        ...
	        <div class="box">
		    	...
		    	<div class="col-md-12">
		    		...
		    		<textarea class="form-control" rows="50" placeholder="내용" name="mContent">${fn:replace(readMagazine.mContent, cn, br)}</textarea>		    		
		    		<br>
		    		<br>
		    		<br>		    		
		    	</div>
