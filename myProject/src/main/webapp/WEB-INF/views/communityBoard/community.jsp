...
<script type="text/javascript">
	$(function(){
		...
		$("#newBtn").on("click", function(){
			self.location = "registerCommunity";
		});
        ...
        <div class="row">
			...
			<div class="box">
				<table class="table table-hover">
					...
					<c:forEach items="${list }" var="communityBoardVo">
					<tr>
 					 	<td class="text-center">${communityBoardVo.cNo }</td>
 					 	<td style="padding-left: 30px;">
 					 		<a href="/communityBoard/readCommunity${pageMaker.makeQuery(pageMaker.cri.page) }&cNo=${communityBoardVo.cNo }">
 					 		${communityBoardVo.cTitle }
 					 		</a>
 					 		&nbsp;&nbsp;&nbsp;<span class="badge">${communityBoardVo.replyCnt }</span>
 					 	</td>
 					 	<td class="text-center">${communityBoardVo.recommend }</td>
 					 	<td class="text-center">${communityBoardVo.viewCnt }</td>
 					 	<td class="text-center"><fmt:formatDate value="${communityBoardVo.regDate }" pattern="yyyy-MM-dd HH:mm"/></td>
 					 </tr>
					</c:forEach>
				...
				<div class="text-center">
					<ul class="pagination">
						<c:if test="${pageMaker.prev }">
							<li><a href="community${pageMaker.makeQuery(pageMaker.startPage - 1) }">&laquo;</a></li>
						</c:if>
						...
						<c:if test="${pageMaker.next && pageMaker.endPage > 0 }">
							<li><a href="community${pageMaker.makeQuery(pageMaker.endPage + 1) }">&raquo;</a></li>
						</c:if>
					</ul>
				</div>
