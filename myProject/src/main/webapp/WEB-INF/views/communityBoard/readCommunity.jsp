...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#modify").click(function(){
			$("#formObj").attr("action", "/communityBoard/modifyCommunity");
		...
		$("#remove").click(function(){
			...
			$("#formObj").attr("action", "/coummunityBoard/removeCommunity");
			$("#formObj").submit();
		});
		...
		/* LIST REPLY */
		getPage("/cReplies/" + cNo + "/1");
		
		/* 댓글 페이징 이벤트 */
		$(".pagination").on("click", "li a", function(event) {
			event.preventDefault();
			replyPage = $(this).attr("href");
			getPage("/cReplies/" + cNo + "/" + replyPage);
		});
		...
		$("#recommend").on("click", function(){
			if(confirm("게시글을 추천하시겠습니까?")) {
				$.getJSON("/communityBoard/updateRecommend/" + cNo, function(){});
				alert("게시글을 추천하였습니다.");				
			} else {
				return;
			}			
    ...
    <div class="container">
        ...
        <div class="row">
				...
				<form method="post" id="formObj">
					<input type="hidden" name="cNo" value="${readCommunity.cNo}" readonly="readonly" />
        	...
        	<div class="box">
        		<div class="col-lg-12">
        			...
        			&nbsp;
        			<strong> ${readCommunity.cTitle }</strong>
        		...
        		<div class="col-lg-12">
        			<div>
        				...
        				<div style="float: right;">
        					...
        					<span>댓글 <span id="newsDelReplyCnt">${readCommunity.replyCnt }</span></span>
        				</div>
	        ...
	        <div class="box">
		    	...
		    	<div class="col-md-12" style="padding: 60px">
		    		...
		    		${fn:replace(readCommunity.cContent, cn, br)}
		    		<br>
		    		<br>
		    		<br>
